package com.capgemini.csv_data_handling.advance_problems.detect_duplicates_in_csv_file;
...
public class DetectDuplicate {
    ...
    public static void findDuplicates(String fileName){
        String filePath = "src/main/java/com/capgemini/csv_data_handling/advance_problems/detect_duplicates_in_csv_file/" + fileName;  // CSV file name
