package com.capgemini.csv_data_handling.advance_problems.large_csv_file_reader;
...
public class LargeCSVReader {
    ...
    public static void main(String[] args) {
        String filePath = "src/main/java/com/capgemini/csv_data_handling/advance_problems/large_csv_file_reader/Students.csv"; // Path to the large CSV file
