package com.capgemini.csv_data_handling.intermediate_problems.modify_a_csv_file;
...
public class UpdateCSVFile {
    ...
    public static List<String[]> readFile(String sourceFileName){
        ...
        String sourceFilePath = "src/main/java/com/capgemini/csv_data_handling/intermediate_problems/modify_a_csv_file/"+ sourceFileName;
    ...
    public static void writeFile(List<String[]> employeesData, String destinationFileName){
        String destinationFilePath = "src/main/java/com/capgemini/csv_data_handling/intermediate_problems/modify_a_csv_file/"+ destinationFileName;
